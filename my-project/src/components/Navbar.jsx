      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex space-x-10 mr-6">
            <Link
              to="/"
              className="flex items-center text-sm font-bold text-gray-700 hover:text-purple-600 group"
            >
              <img
                src={HomeIcon}
                alt="Home"
                className="mr-2 h-5 w-6 group-hover:fill-current group-hover:text-purple-600"
              />
              <span>Beranda</span>
            </Link>
            <Link
